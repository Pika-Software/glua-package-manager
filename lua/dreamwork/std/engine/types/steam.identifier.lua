...
local Identifier = class.base( "Identifier" )
...
local IdentifierClass = class.create( Identifier )
...
-- TODO: replace table below with ascii library function
